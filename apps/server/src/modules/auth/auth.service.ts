...
export class AuthService {
    ...
    toPublicUser(user: User): UserPublic {
        return {
            ...
            profileEducation: user.profileEducation,
            profileLanguages: user.profileLanguages,
            profileProjects: user.profileProjects,
            profileCertifications: user.profileCertifications,
            profileHobbies: user.profileHobbies,
            profileCvConfig: user.profileCvConfig,
